...
var Firebase = (function () {
    function Firebase(config, options) {
        ...
        this.doCreateUser = function (props) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2, new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, this.functions.httpsCallable("createAuthUser")(props)];
                                case 1:
                                    result = _a.sent();
                                    resolve(__assign({}, result.data));
                                    return [2];
                            }
                        });
                    }); })];
